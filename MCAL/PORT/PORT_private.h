...
/*macros for defining the DDRA register value to estimate the pin DIRECTION INPUT or OUTPUT */
...
/*macros for defining the PORT register value to estimate the pin VALUE HIGH or LOW */
